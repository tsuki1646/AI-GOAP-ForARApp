...
public class PortalPlace : MonoBehaviour
{
    ...
    //This is the gameobject reference instantiated after a successful raycast intersection with a plane
    ...
    void Update()
    {
        if (Input.touchCount > 0)
        {
            ...
            if (m_ARRaycastManager.Raycast(touch.position, raycast_hits, TrackableType.PlaneWithinPolygon))
            {
