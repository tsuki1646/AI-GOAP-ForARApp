...
public class WInterface_ARCamera_4_MultiPrefabs : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        bookButton.onClick.AddListener(() => ChangePrefabTo("Book_Lean"));
        tableButton.onClick.AddListener(() => ChangePrefabTo("Table_Lean"));
        toiletButton.onClick.AddListener(() => ChangePrefabTo("Toilet_Lean"));
