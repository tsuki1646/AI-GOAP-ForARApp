...
public class Logger_ForMany : Singleton<Logger>
{   
    [SerializeField]
    ...
    public void OnARObjectPlaced(
        ARPlacementInteractableMany arPlacementInteractableMany, 
        GameObject placedObject)
    {
        Logger.Instance.LogInfo(arPlacementInteractableMany.name);
